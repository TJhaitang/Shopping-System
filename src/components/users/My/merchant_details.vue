<template>
  <div class="goods" id="goods" name="goods">
    ...
    <div class="mer-header">
      <div class="mer-header-content">
        <p>
          <i  style="color:#ff6700; font-weight: 600;"></i>
          欢迎光临{{this.merchantInfo.username}}的小店~
        </p>
        <span>
            <p>
          <i  style="color:#ff6700; font-weight: 100;"></i>
          店铺平均评分：{{this.merchantInfo.avgScore}}分
          发货省：{{this.merchantInfo.province}}
        </p></span>
      </div>
    </div>
    <!-- 店铺头部END -->
...
.goods .head1 .mer-header {
  height: 90px;
  border-bottom: 2px solid #ff6700;
  background-color: #fff;
  margin-bottom: 20px;
}
.goods .head1 .mer-header .mer-header-content {
  width: 1225px;
  margin: 0 auto;
}
.goods .head1 .mer-header p {
  font-size: 28px;
  line-height: 58px;
  float: left;
  font-weight: normal;
